...
const AdminDashboardSideBar = () => {
  ...
  return (
    <div className="hidden lg:fixed z-10 lg:inset-y-0 lg:flex lg:w-72 lg:flex-col lg:bg-gradient-to-r lg:from-indigo-900 lg:to-blue-950 lg:pb-6 shadow-xl ">
      <div className="py-5 border-b-2 border-blue-800 mb-5">
        ...
        <div className="h-full overflow-x-hidden scrollbar-hid">
          <nav className="flex-1 space-y-2">
            {navItems.map((item) => (
              <Link
                key={item.path}
                to={item.path}
                className={`flex items-center px-8 py-3 roundd-lg transition-colors ${
