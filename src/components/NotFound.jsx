  ...
  return (
    <div className="absolute w-full h-screen top-0">
      <div className="relative ">
        <div className="h-screen top-0 w-full absolute z-50 flex flex-col items-center justify-center bg-[#fbf9f6] text-center px-4">
          <img src="icnon_beaver.png" className="absolute h-[80vh] left-20 hidden lg:block" alt="" />
